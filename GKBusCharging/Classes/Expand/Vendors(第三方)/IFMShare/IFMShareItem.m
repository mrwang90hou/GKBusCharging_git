...
NSString *const  IFMPlatformNameWechatFriend = @"IFMPlatformNameWechatFriend";
NSString *const  IFMPlatformNameQQSpace = @"IFMPlatformNameQQSpace";
...
//        messageDict = @{@"image":@"share_sina",@"title":@"新浪微博",@"action":IFMPlatformHandleSina};
        messageDict = @{@"image":@"icon_share_weibo",@"title":@"微博",@"action":IFMPlatformHandleSina};
    }
    if ([platformName isEqualToString:IFMPlatformNameQQ]) {
//        messageDict = @{@"image":@"share_qq",@"title":@"QQ",@"action":IFMPlatformHandleQQ};
        messageDict = @{@"image":@"icon_share_qq",@"title":@"QQ",@"action":IFMPlatformHandleQQ};
    }
    ...
    if ([platformName isEqualToString:IFMPlatformNameWechat]) {
        ...
        messageDict = @{@"image":@"icon_share_wacte",@"title":@"微信",@"action":IFMPlatformHandleWechat};
    }
    ...
    if ([platformName isEqualToString:IFMPlatformNameWechatFriend]) {
        //        messageDict = @{@"image":@"share_weixin",@"title":@"微信",@"action":IFMPlatformHandleWechat};
        messageDict = @{@"image":@"icon_share_friend",@"title":@"朋友圈",@"action":IFMPlatformHandleWechat};
    }
    if ([platformName isEqualToString:IFMPlatformNameQQSpace]) {
        messageDict = @{@"image":@"icon_share_qq_space",@"title":@"空间",@"action":IFMPlatformHandleAlipay};
    }
