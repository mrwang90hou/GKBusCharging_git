...
- (instancetype)initWithFrame:(CGRect)frame {
    ...
    if (self) {
        ...
        //        _cancleButton.titleLabel.textColor = [UIColor greenColor];
        [_cancleButton setTitleColor:BUTTONMAINCOLOR forState:UIControlStateNormal];
        //        [_cancleButton setTintColor:[UIColor greenColor]];
...
- (void)showInView:(UIView *)view{
    ...
    if (!_showCancleButton) {
        ...
        [_cancleButton setTintColor:BUTTONMAINCOLOR];
        [_cancleButton setTitleColor:BUTTONMAINCOLOR forState:UIControlStateNormal];
