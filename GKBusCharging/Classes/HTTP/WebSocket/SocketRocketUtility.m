...
NSString * const kWebSocketBreakUpNote = @"kWebSocketBreakUpNote";
...
-(void)sentheart{
    ...
    //    [self sendData:@"?type=selectcharge&userId=03f194e58a16437fa8fc857a5dcabc45&socketId=9999887712345605"];
}
...
- (void)webSocket:(SRWebSocket *)webSocket didFailWithError:(NSError *)error {
    ...
    if (webSocket == self.socket) {
        NSLog(@"************************** socket 连接失败************************** ");
        [[NSNotificationCenter defaultCenter] postNotificationName:kWebSocketBreakUpNote object:nil];
        _socket = nil;
        //连接失败就重连
        //        [self reConnect];
    }
