...
#ifndef GKGlobalStyle_h
#define GKGlobalStyle_h
...
#define KNotiUserNameChange @"KNotiUserNameChange"
#define KNotiPhoneNumberChange @"KNotiPhoneNumberChange"
/**
 连接服务器状态
