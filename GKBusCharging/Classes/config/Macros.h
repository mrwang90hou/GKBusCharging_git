...
#define RGBall(r) RGBA(r,r,r,1.0f)
...
#define GFPinkCokor RGB(214,0,126)
#define GFPink2Cokor RGB(255,105,180)        //#FF69B4
#define GFOrgangeCokor RGB(200,85,55)
#define GFYellowCokor RGB(223,171,58)
...
#define UserInfoData [GKUserInfo findAll].lastObject
...
//#define GoodsHandheldImagesArray  @[@"intro_img_01",@"intro_img_02",@"intro_img_03",@"intro_img_04",@"intro_img_05"]
//
//
////滑动页【SilderImages】
...
//#define GoodsHomeSilderImagesArray @[@"home_icon_bottom_silder01",@"home_icon_bottom_silder01",@"home_icon_bottom_silder01",@"home_icon_bottom_silder01",@"home_icon_bottom_silder01"]
//
//
//
...
//#define HomeBottomViewGIFImage @"intro_img_00"
//
//
////URL
